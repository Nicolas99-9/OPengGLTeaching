...
#pragma region "object_initialization"
	...
	// Load textures
	GLuint cubeTexture = loadTexture("images/container.jpg",false);
	GLuint floorTexture = loadTexture("images/sol.jpg",false);
	GLuint transparentTexture = loadTexture("images/blending_transparent_window.png", true);


	//enable different levels of transparency 
	glEnable(GL_BLEND);
