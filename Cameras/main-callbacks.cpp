...
//the mouse position, initialy at the middle of the scene
...
{  
	...
	//avoid a "bump" when using for the first time
	if (firstMouse)
	{
		lastX = xpos;
		lastY = ypos;
	...
	//decrease movment speed
	GLfloat sensitivity = 0.05;	// Change this value to your liking
	xoffset *= sensitivity;
	yoffset *= sensitivity;


	//add the offset to pitch and yaw
	yaw += xoffset;
	pitch += yoffset;
...
int main(void) {
   ...
   //------------------------------------------------------------
	...
	//att the offset value to the yaw and pitch value
	//add the constraints for the yaw and pitch max value
	//calculate the direction vector
